 ...
 * @author reyes
 */
public class Withdraw2 extends javax.swing.JPanel {

    private Frame frame;
    public static String acc;

    public Withdraw2(Frame frame) {
        initComponents();
        limits();
    ...
    public void forward(String Username, String Password) {
        ...
        try {
            ...
            String sql = "SELECT Acc_number,balance FROM New_Registered_User WHERE Username = ? AND Password = ?";
            ...
            if (rs.next()) {
                ...
                if (BAL >= Frame.bal) {
                    ...
                    CLASS_PANES.showMessageBox("Insufficient balance! " + "                                             Current Balance: " + BAL + " Php");
                     CLASS_PANES.showMessageBox("Redirecting you to main screen");
                    NAME.setText(null);
    ...
    private void CONFIRMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CONFIRMActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                String sql2 = "SELECT * FROM onhold WHERE Username = ? ";
