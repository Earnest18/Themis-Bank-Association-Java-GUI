 ...
 * @author Carl joshua
 */
public class Deposit1 extends javax.swing.JPanel {

    private Frame frame;
    public static  String raw;
    public static  String formatted;
    public static  int caretPos;
    public Deposit1(Frame frame) {
        initComponents();
...
class NumericFilter extends DocumentFilter {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PANEL IMAGES/AC_TRANSAC-DP.png"))); // NOI18N
        add(jLabel1);
    ...
    private void CONFIRMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CONFIRMActionPerformed
         ...
         if(amount >=500 && amount <= 10000000){
             ...
             int i =CLASS_PANES.showConfirmBox("Are you sure you want to deposit an amount of " + AMOUNT.getText() + "  on you account?");
             if(i == JOptionPane.YES_OPTION){
                 
                 Frame.bal=amount;
                 CLASS_PANES.showMessageBox("You may proceed to Step 2 for account verification");
                 
                 Deposit2 transac = new Deposit2(frame);
                 frame.setContentPane(transac);
                 frame.revalidate();
             ...
             CLASS_PANES.showMessageBox("You cannot deposit an amount " + amount + " Php.\n Minimum deposit requirement: 500 Php");
             AMOUNT.setText(null);
         }else if(amount >10000000){
            CLASS_PANES.showMessageBox("You cannot deposit an amount " + amount + " Php.\n Maximum deposit requirement: 10,000,000 Php");
                 AMOUNT.setText(null);
         }
         }else{
