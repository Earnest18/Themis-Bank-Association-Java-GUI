...
completed.getColumnModel().getColumn(7).setPreferredWidth(80);  
    ...
    private void initComponents() {
        ...
        CANCELLED.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BUTTON IMAGES/fill.png"))); // NOI18N
        CANCELLED.setBorderPainted(false);
        CANCELLED.setContentAreaFilled(false);
        CANCELLED.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BUTTON IMAGES/hover_trans.png"))); // NOI18N
        CANCELLED.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BUTTON IMAGES/hover_trans.png"))); // NOI18N
        ...
        add(CANCELLED);
        CANCELLED.setBounds(0, 365, 318, 90);
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PANEL IMAGES/AD_HCOM.gif"))); // NOI18N
        add(background);
