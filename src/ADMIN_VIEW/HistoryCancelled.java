...
public class HistoryCancelled extends javax.swing.JPanel {
    ...
    public HistoryCancelled(CLIENT_VIEW.Frame frame) {
        initComponents();
        update();
        this.frame = frame;jScrollPane1.setOpaque(false);
...
public void TABLE(JTable cancelled) {
    ...
    private void initComponents() {
        ...
        COMPLETED.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BUTTON IMAGES/fill.png"))); // NOI18N
        COMPLETED.setBorderPainted(false);
        COMPLETED.setContentAreaFilled(false);
        COMPLETED.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BUTTON IMAGES/hover_trans.png"))); // NOI18N
        COMPLETED.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BUTTON IMAGES/hover_trans.png"))); // NOI18N
        ...
        add(COMPLETED);
        COMPLETED.setBounds(0, 273, 318, 90);
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PANEL IMAGES/AD_HCAN.gif"))); // NOI18N
        add(background);
