...
public class QueueManagement extends javax.swing.JPanel {
    ...
    public void disable_buttons(boolean choose) {
        S1.setEnabled(choose);
        S2.setEnabled(choose);
        S3.setEnabled(choose);
        S4.setEnabled(choose);
    ...
    public void determiner(String counter) {
        ...
        if (window.equalsIgnoreCase("Withdraw")) {
            T1.setVisible(true);C1.setVisible(true);  S1.setVisible(true); N1.setVisible(true);CO1.setVisible(true);
            T2.setVisible(false);C2.setVisible(false);S2.setVisible(false);N2.setVisible(false);CO2.setVisible(false);
            T3.setVisible(false); C3.setVisible(false);S3.setVisible(false);N3.setVisible(false);CO3.setVisible(false);
            T4.setVisible(false);C4.setVisible(false);  S4.setVisible(false);N4.setVisible(false);CO4.setVisible(false);
            show_only = "Withdraw";

        } else if (window.equalsIgnoreCase("Deposit")) {
            T1.setVisible(false);C1.setVisible(false);  S1.setVisible(false); N1.setVisible(false);CO1.setVisible(false);
            T2.setVisible(true);C2.setVisible(true);S2.setVisible(true);N2.setVisible(true);CO2.setVisible(true);
            T3.setVisible(false); C3.setVisible(false);S3.setVisible(false);N3.setVisible(false);CO3.setVisible(false);
            T4.setVisible(false);C4.setVisible(false);  S4.setVisible(false);N4.setVisible(false);CO4.setVisible(false);
            show_only = "Deposit";
            ...
            T1.setVisible(false);C1.setVisible(false);  S1.setVisible(false); N1.setVisible(false);CO1.setVisible(false);
            T2.setVisible(false);C2.setVisible(false);S2.setVisible(false);N2.setVisible(false);CO2.setVisible(false);
            T3.setVisible(true); C3.setVisible(true);S3.setVisible(true);N3.setVisible(true);CO3.setVisible(true);
            T4.setVisible(false);C4.setVisible(false);  S4.setVisible(false);N4.setVisible(false);CO4.setVisible(false);
            show_only = "Loan";
            ...
            T2.setVisible(false);C2.setVisible(false);S2.setVisible(false);N2.setVisible(false);CO2.setVisible(false);
            T3.setVisible(false); C3.setVisible(false);S3.setVisible(false);N3.setVisible(false);CO3.setVisible(false);
            T4.setVisible(true);C4.setVisible(true);  S4.setVisible(true);N4.setVisible(true);CO4.setVisible(true);
            show_only = "Inquire";
                    ...
                    if (id != -1) {
                        ...
                        try (java.sql.PreparedStatement psInsert = con.prepareStatement(insertCompleted)) {
                            ...
                            if (rs.next()) {
                                ...
                                tellers = EMPLOYEE_VIEW.Log.tellername;
    ...
    public void loadOnHoldTable(String show, JTable onHoldTable) {
        ...
        try {
            ...
            try (java.sql.Connection con = java.sql.DriverManager.getConnection(
                ...
                String sql = "SELECT Username, MobileNum, Que_Num, Transaction_Type, Amount, Acc_number, Date, Time FROM onhold WHERE Transaction_Type = ? ORDER BY id ASC";
    ...
    private void ONHOLDMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ONHOLDMousePressed
        ...
        if (row != -1) {
            ...
            String[] options = {"Recover", "Skipped", "Cancel"};
            int choice = CLASS_PANES.SelectionBox(options, "Are you sure you want to recover this user?");
